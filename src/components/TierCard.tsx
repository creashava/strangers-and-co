...
export default function TierCard({
  ...
  return (
    <div
      className={`relative flex flex-col justify-between rounded-3xl p-6 sm:p-8 transition-all duration-300 border-2 bg-[#F9FAF7] border-[#86EFAC] hover:border-[#15803D] shadow-sm hover:shadow-xl hover:shadow-emerald-100 ${
    ...
    >
      ...
      <div>
        <div className="flex items-center justify-between gap-3 mb-5">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold tracking-wide uppercase bg-[#DCFCE7] text-[#166534]">
            <Crown size={13} className="text-[#15803D]" />
            {config.badge}
          </span>
      ...
      <div>
        ...
        >
          {isLoading ? (
            ...
            <>
              <span>Book General Pass (₹{config.price})</span>
              <ArrowRight size={16} />
            </>
          )}
        </button>
